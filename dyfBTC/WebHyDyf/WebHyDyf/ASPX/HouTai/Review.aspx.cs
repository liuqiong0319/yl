...
{
    public partial class Review : WebHyDyf.SysCode.PageLog
    {
        ...
        protected void LinkButton3_Click(object sender, EventArgs e)
        {
            ...
            string sql = "update dyf_ypdm set shbs=1 where id=" + lb.CommandArgument + "";
        ...
        protected void LinkButton5_Click(object sender, EventArgs e)
        {
            ...
            LinkButton lb = (LinkButton)sender;
            string sql = "update dyf_ypdm set shbs=2 where id=" + lb.CommandArgument + "";
            int num = HyeyClass.DBUtility.DbHelperSQL.ExecuteSql(sql);
            if (num > 0)
            {
                MessageBox("设置成功！");
