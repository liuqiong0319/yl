<%@ Page Title="" Language="C#" MasterPageFile="~/ASPX/HouTai/HouT.Master" AutoEventWireup="true" CodeBehind="ShopOrders.aspx.cs" Inherits="WebHyDyf.ASPX.Shop.ShopOrders" %>
                ...
                <asp:Repeater ID="rp_List" OnItemDataBound="rp_List_ItemDataBound" runat="server">
                    ...
                    <ItemTemplate>
                        <tr>
                            ...
                            <td>
                                <asp:Label ID="Label1" runat="server" Text='<%# Eval("ltitle") %>'></asp:Label>&nbsp<asp:Label ID="lblwuliu" runat="server" Text='<%# Eval("logistics") %>'></asp:Label>
                            </td>
                            <td>
                                <asp:LinkButton ID="LinkButton3" OnClick="LinkButton3_Click" CommandArgument='<%# Eval("id") %>' runat="server">取消订单</asp:LinkButton>&nbsp;<asp:LinkButton ID="LinkButton2" OnClick="LinkButton2_Click" CommandArgument='<%# Eval("id") %>' runat="server">查看详情</asp:LinkButton>&nbsp;<asp:LinkButton ID="LinkButton1" OnClick="LinkButton1_Click" CommandArgument='<%# Eval("id") %>' runat="server" Style="display: none;">去付款</asp:LinkButton>&nbsp;<asp:Label ID="lblWc" runat="server" Text="已完成"></asp:Label></td>
                        </tr>
                    </ItemTemplate>
                    <FooterTemplate>
                        </table>
