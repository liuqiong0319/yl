<%@ Page Title="" Language="C#" MasterPageFile="~/ASPX/HouTai/HouT.Master" AutoEventWireup="true" CodeBehind="AuthorityList.aspx.cs" Inherits="WebHyDyf.ASPX.HouTai.AuthorityList" %>
                ...
                <asp:Repeater ID="rp_List" runat="server">
                    ...
                    <ItemTemplate>
                        <tr>
                          ...
                          <td>
                               <asp:Button runat="server" ID="btnT" Class="SouS_SH_A_02"  OnClick="btnT_Click" Text="超级管理员" CommandArgument='<%# Eval("id") %>'  />
                              <asp:Button runat="server" ID="Button1" Class="SouS_SH_A_02"  OnClick="Button1_Click" Text="管理员" CommandArgument='<%# Eval("id") %>'  />
                              <asp:Button runat="server" ID="Button3" Class="SouS_SH_A_02"  OnClick="Button3_Click" Text="删除" CommandArgument='<%# Eval("id") %>'  />
                            </td>
                            </tr>
                    </ItemTemplate>
                    <FooterTemplate>
