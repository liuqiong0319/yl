...
{
    public partial class ShopOrders : WebHyDyf.SysCode.PageLog
    {
        ...
        public void BindGridView()
        {
            ...
            string sql = "select * from dyf_order where username='" + Session["username"].ToString() + "'";
            if (txtDDH.Text != "")
        ...
        protected void rp_List_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            if (e.Item.ItemType == ListItemType.Item || e.Item.ItemType == ListItemType.AlternatingItem)
            {
                ...
                LinkButton lbQfk = (LinkButton)e.Item.FindControl("LinkButton1");
        ...
        protected void LinkButton3_Click(object sender, EventArgs e)
        {
            ...
            string sql = "update dyf_order set  state =2 where id=" + lb.CommandArgument + " and username='" + Session["username"].ToString() + "'";
            int num = HyeyClass.DBUtility.DbHelperSQL.ExecuteSql(sql);
            if (num > 0)
            {
                string sql1 = "update dyf_orderDe set bs=2 where orderid=" + lb.CommandArgument + " and username='" + Session["username"].ToString() + "'";
