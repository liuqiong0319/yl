...
{
    public partial class SalesList : WebHyDyf.SysCode.PageLog
    {
        ...
        public void BindGridView()
        {
            ...
            string sql = "select * from dyf_xsfp where 1=1 ";
            if (txtDDH.Text.Trim() != "")
                sql += " and orderid like '%" + txtDDH.Text.Trim() + "%'";
            if (txtMC.Text.Trim() != "")
                sql += " and ypmc like '%" + txtMC.Text.Trim() + "%'";
            if (txtCD.Text.Trim() != "")
                sql += " and cdmc like '%" + txtCD.Text.Trim() + "%'";
