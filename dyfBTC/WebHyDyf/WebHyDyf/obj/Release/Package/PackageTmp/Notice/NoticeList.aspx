<%@ Page Title="" Language="C#" MasterPageFile="~/ASPX/HouTai/HouT.Master" AutoEventWireup="true" CodeBehind="NoticeList.aspx.cs" Inherits="WebHyDyf.Notice.NoticeList" %>
            ...
            <div class="ShenHe">
                <div class="SouS_SH">
                    ...
                    <div class="SouS_SH;" style="border-bottom: 0px;">
                        ...
                        <div class="SouS_SH_A">
                            新闻标题：<asp:TextBox ID="TextTSWT" runat="server" Class="SouS_SH_A_01" Style="width: 300px;"></asp:TextBox>
                        </div>
                ...
                <asp:Repeater ID="rp_list" runat="server">
                    <HeaderTemplate>
                        <table class="ShenHe-Table">
                            <tr>
                                <th style="width: 350px;">投诉标题</th>
                                <th style="width: auto;">新闻内容</th>
                    ...
                    <ItemTemplate>
                        <tr>
                            <td>
                                <asp:Label ID="LabTSWT" runat="server" Text='<%# Eval("title") %>'></asp:Label>
                            </td>
                            <td style="width: 350px; white-space: nowrap; text-overflow: ellipsis; overflow: hidden;">
                                <asp:Label ID="LabTSNR" runat="server" Text='<%# Eval("tContent") %>'></asp:Label></td>
                            <td>
                                <asp:Label ID="LabTSSJ" runat="server" Text='<%# Eval("inserttime") %>'></asp:Label>
                            </td>
                            <td>
                                <a>查看详情</a>&nbsp;&nbsp;<a href="/Notice/SendNotice.aspx?id=<%# Eval("id") %>">修改</a>
